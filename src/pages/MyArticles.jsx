...
export default function MyArticlesPage({ memberInfo }) {
  ...
  const displayName = (typeof displayNameSetting === 'string' && displayNameSetting) || 'Articles';
              ...
              <Card className="border-slate-200 shadow-sm">
                <CardContent className="p-12 text-center">
                  ...
                  <h3 className="text-xl font-semibold text-slate-900 mb-2">
                    {searchQuery || statusFilter !== 'all' || selectedSubcategories.length > 0 ? `No ${displayName.toLowerCase()} found` : `No ${displayName.toLowerCase()} yet`}
                  </h3>
              ...
              <>
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-3">
                  <div className="text-sm text-slate-600">
                    Showing {sortedArticles.length} {sortedArticles.length === 1 ? singularDisplayName.toLowerCase() : displayName.toLowerCase()}
                  </div>
